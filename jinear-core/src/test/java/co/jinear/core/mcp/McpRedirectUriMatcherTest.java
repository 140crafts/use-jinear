...
import co.jinear.core.service.mcp.oauth.McpRedirectUriMatcher;
 ...
 */
class McpRedirectUriMatcherTest {

    private final McpRedirectUriMatcher matcher = new McpRedirectUriMatcher();
