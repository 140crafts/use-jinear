...
public class GoogleApisClientConfig {
    ...
    @Bean
    public UriTemplateHandler googleApisUriTemplateHandler() {
        return new DefaultUriBuilderFactory(gCloudProperties.getGoogleApisBaseUrl());
    }
}
