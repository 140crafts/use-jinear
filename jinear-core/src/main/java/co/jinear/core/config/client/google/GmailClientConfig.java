...
public class GmailClientConfig {
    ...
    @Bean("gmailRestTemplate")
    public RestTemplate gmailRestTemplate(UriTemplateHandler googleApisGmailUriTemplateHandler,
        ...
        restTemplate.setUriTemplateHandler(googleApisGmailUriTemplateHandler);
    ...
    @Bean
    public UriTemplateHandler googleApisGmailUriTemplateHandler() {
        return new DefaultUriBuilderFactory(gCloudProperties.getGoogleApisGmailBaseUrl());
    }
}
