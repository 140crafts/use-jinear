...
public class AccountPasswordService {
    ...
    public boolean isPasswordAutoGenerated(String accountId) {
        log.info("Is password auto generated has started for accountId: {}", accountId);
        boolean isPasswordAutoGenerated = Optional.of(accountId)
                .map(this::retrieveAccountPassword)
                .map(AccountPassword::getAutoGenerated)
                .orElse(Boolean.TRUE);
        log.info("Is password auto generated has completed for accountId: {}, isPasswordAutoGenerated: {}", accountId, isPasswordAutoGenerated);
