...
public class TaskSubscriptionNotificationSendConverter {
    ...
    public static final Map<WorkspaceActivityType, LocaleStringType> TITLE_MAP = Map.ofEntries(
            ...
            entry(ATTACHMENT_ADDED, WORKSPACE_ACTIVITY_NOTIFICATION_TITLE_ATTACHMENT_ADDED),
            entry(ATTACHMENT_DELETED, WORKSPACE_ACTIVITY_NOTIFICATION_TITLE_ATTACHMENT_DELETED)
    );
    ...
    public static final Map<WorkspaceActivityType, NotificationType> NOTIFICATION_TYPE_MAP = Map.ofEntries(
            ...
            entry(TASK_NEW_COMMENT, NotificationType.TASK_NEW_COMMENT),
            entry(ATTACHMENT_ADDED, NotificationType.TASK_ATTACHMENT_ADDED),
            entry(ATTACHMENT_DELETED, NotificationType.TASK_ATTACHMENT_DELETED)
    );
