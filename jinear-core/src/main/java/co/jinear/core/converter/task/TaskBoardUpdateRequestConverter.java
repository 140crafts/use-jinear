...
import co.jinear.core.model.request.task.TaskBoardUpdateColorRequest;
...
import co.jinear.core.model.vo.task.UpdateTaskBoardColorVo;
...
public interface TaskBoardUpdateRequestConverter {
    ...
    UpdateTaskBoardColorVo convert(TaskBoardUpdateColorRequest taskBoardUpdateColorRequest);
}
