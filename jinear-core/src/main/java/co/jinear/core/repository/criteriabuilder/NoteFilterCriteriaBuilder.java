...
public class NoteFilterCriteriaBuilder {
    ...
    public void addParentNoteIdIsNull(boolean parentNoteIdIsNull, CriteriaBuilder criteriaBuilder, Root<Note> root, List<Predicate> predicateList) {
        if (parentNoteIdIsNull) {
