...
@RequestMapping(value = "v1/task/checklist/item")
public class TaskChecklistItemController {
    ...
    public BaseResponse initializeChecklistItem(@RequestBody ChecklistItemLabelRequest checklistItemLabelRequest) {
        return taskChecklistItemManager.initializeChecklistItem(checklistItemLabelRequest);
    }

    @PutMapping("/{checklistItemId}/{checked}")
    @ResponseStatus(HttpStatus.OK)
    public BaseResponse updateCheckedStatus(@PathVariable String checklistItemId,
    ...
    @ResponseStatus(HttpStatus.OK)
    public BaseResponse updateLabel(@PathVariable String checklistItemId,
    ...
    @ResponseStatus(HttpStatus.OK)
    public BaseResponse deleteChecklistItem(@PathVariable String checklistItemId) {
