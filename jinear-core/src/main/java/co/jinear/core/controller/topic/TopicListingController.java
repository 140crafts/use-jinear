...
public class TopicListingController {
    ...
    public TopicListingResponse retrieveTeamTopics(@PathVariable String teamId,
    ...
    @ResponseStatus(HttpStatus.OK)
    public TopicSearchResponse searchTeamTopics(@PathVariable String teamId,
                                                @RequestParam(required = false, defaultValue = "") String nameOrTag) {
