import type {FeedContentItemResponse, FeedContentResponse} from "@/model/be/jinear-core";
import {api} from "./api";

export const feedContentApi = api.injectEndpoints({
    endpoints: (build) => ({
        //
        retrieveFeedContent: build.query<FeedContentResponse, {
            workspaceId: string;
            feedId: string;
            pageToken?: string
        }>({
        ...
        //
        retrieveFeedContentItem: build.query<FeedContentItemResponse, {
            workspaceId: string;
            feedId: string;
            itemId: string
        }>({
...
export const {
    useRetrieveFeedContentQuery,
    useLazyRetrieveFeedContentQuery,
    useRetrieveFeedContentItemQuery
} = feedContentApi;
