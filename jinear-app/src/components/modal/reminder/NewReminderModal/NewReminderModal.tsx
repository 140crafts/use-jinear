...
import type {RepeatType, TaskReminderDto, TaskReminderInitializeRequest} from "@/model/be/jinear-core";
...
const NewReminderModal: React.FC<NewReminderModalProps> = ({}) => {
    ...
    const hasAnyAssignedDateReminder = task?.taskReminders?.find(
        (taskReminder: TaskReminderDto) => taskReminder.taskReminderType == "ASSIGNED_DATE"
    );
    ...
    const hasAnyDueDateReminder = task?.taskReminders?.find((taskReminder: TaskReminderDto) => taskReminder.taskReminderType == "DUE_DATE");
                            ...
                            <div className={styles.repeatContainer}>
                                ...
                                {repeat && (
                                    <div>
                                        ...
                                        <div className={styles.dateTimePickerContainer}>
                                            <input id={"remind-end-date"}
                                                   type={"hidden"} {...register("specificRemindRepeatEnd")} />
                                            <Button variant={ButtonVariants.filled}
                                                    onClick={popDatePickerForSpecificRemindRepeatEndDate}>
