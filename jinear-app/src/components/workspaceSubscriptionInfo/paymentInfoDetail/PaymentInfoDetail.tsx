...
import type { SubscriptionPaymentInfoDto } from "@/model/be/jinear-core";
...
const PaymentInfoDetail: React.FC<PaymentInfoDetailProps> = ({ subscriptionPaymentInfo }) => {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.priceInfo}>{`${subscriptionPaymentInfo.saleGross} ${subscriptionPaymentInfo.currency}`}</div>
