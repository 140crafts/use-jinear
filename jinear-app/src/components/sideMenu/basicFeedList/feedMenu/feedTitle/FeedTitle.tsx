...
import type {FeedDto, WorkspaceDto} from "@/model/be/jinear-core";
...
const FeedTitle: React.FC<FeedTitleProps> = ({feed, workspace}) => {
    ...
    return (
        <div className={styles.container}>
            ...
            <Button variant={ButtonVariants.hoverFilled2} href={membersUri}
                    data-tooltip-right={t("sideMenuFeedMembers")}>
                <IoPeopleOutline/>
            </Button>
            {isAdmin && (
                <Button variant={ButtonVariants.hoverFilled2} href={settingsUri}
                        data-tooltip-right={t("sideMenuFeedSettings")}>
