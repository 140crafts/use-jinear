...
import type {CalendarDto} from "@/be/jinear-core";
    ...
    return (
        <div className={styles.container}>
            ...
            >
                ...
                <select onChange={onCalendarChange} className={styles.calendarSelect}
                        value={selectedCalendar?.calendarId}
                        disabled={!calendarChangeable}>
                    {calendarList?.map(calendar =>
                        <option key={"external-calendar-and-source-picker" + calendar.calendarId}
