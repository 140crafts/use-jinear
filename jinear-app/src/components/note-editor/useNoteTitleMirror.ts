 ...
 */
export const useNoteTitleMirror = ({doc, note, workspaceId, pendingDraftId}: IUseNoteTitleMirrorProps) => {
    ...
    }, [titleFromDoc, note, workspaceId, pendingDraftId], PUSH_DEBOUNCE_MS);
};
