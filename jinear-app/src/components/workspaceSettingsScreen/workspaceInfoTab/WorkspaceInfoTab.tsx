...
import type {LocaleType, WorkspaceDto} from "@/model/be/jinear-core";
import {useUpdateWorkspaceProfilePictureMutation} from "@/store/api/workspaceMediaApi";
import {changeLoadingModalVisibility, closeBasicTextInputModal, popBasicTextInputModal} from "@/store/slice/modalSlice";
            ...
            <div className={styles.profileContainer}>
                ...
                <div className={styles.infoContainer}>
                    ...
                    <div>
                        ...
                        <h3>
                            <Link target="_blank" to={`${HOST}/${workspace?.username}`}>
                    ...
                    <div className={styles.workspaceTierContainer}>
                        ...
                        <WorkspaceUpgradeButton workspace={workspace} variant={"FULL"}
