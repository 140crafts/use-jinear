...
import type {MaterialAccessType, MaterialDto, WorkspaceDto} from "@/be/jinear-core";
...
import {API_ROOT, HOST} from "@/util/constants";
...
const ACCESS_TYPE_TOOLTIP_MAP: Record<MaterialAccessType, StringKeys> = {
