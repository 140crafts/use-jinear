...
import type {MaterialSearchContentFilterType, MaterialSearchSortType, PathAwareMaterialDto} from "@/be/jinear-core";
import Breadcrumb from "@/components/workspaceFilesPage/folderHeader/breadcrumb/Breadcrumb";
import Button, {ButtonHeight, ButtonVariants} from "@/components/button";
import {LuCamera, LuFileText, LuFolder, LuFolderPlus, LuHaze, LuHouse, LuPlus, LuSendToBack} from "react-icons/lu";
import useTranslation, {type StringKeys} from "@/locals/useTranslation";
...
const getIconAndTitle = ({isInRoot, isInRecent, isInImages, isInDocuments, isInShared}: {
    ...
    if (isInRoot) {
        return {Icon: LuHouse, title: "folderHeaderTitleHome" as StringKeys};
    } else if (isInRecent) {
        return {Icon: LuHaze, title: "sideMenuFilesRecentFiles" as StringKeys};
    } else if (isInImages) {
        return {Icon: LuCamera, title: "sideMenuFilesImageFiles" as StringKeys};
    } else if (isInDocuments) {
        return {Icon: LuFileText, title: "sideMenuFilesDocumentFiles" as StringKeys};
    } else if (isInShared) {
        return {Icon: LuSendToBack, title: "sideMenuSharedFiles" as StringKeys};
    }
    return {Icon: LuFolder, title: "folderHeaderTitleDefault" as StringKeys};
};
