...
import type {WorkspaceMemberInviteRequest} from "@/model/be/jinear-core";
...
const WorkspaceMemberInvitationForm: React.FC<WorkspaceMemberInvitationFormProps> = ({
                                                                                         workspaceId,
                                                                                         onInviteSuccess
                                                                                     }) => {
            ...
            {isTeamsResponseLoading ? (
                ...
                >
                    ...
                    <label className={styles.label} htmlFor={"new-member-mail"}>
                        ...
                        <input id={"new-member-mail"}
                               type={"email"} {...register("email", {required: t("formRequiredField")})} />
