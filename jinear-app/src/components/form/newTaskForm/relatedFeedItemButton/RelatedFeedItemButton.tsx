...
const RelatedFeedItemButton: React.FC<RelatedFeedItemButtonProps> = ({
            ...
            <SelectDeselectButton
                ...
                selectedComponent={
                    <div className={styles.selectedContainer}>
                        <LuMailCheck/>
                        <div
                            className="line-clamp">{initialRelatedFeedItemData?.itemTitle || t("newTaskFormFeedItemDefaultTitle")}</div>
                    </div>
                }
