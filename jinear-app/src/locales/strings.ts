...
const translations = {
    ...
    homescreenHeroText: {
        en: "Jinear is a project management suite, tasks, calendar, team chat, and file storage, that runs on your own server. You control the data.",
        tr: "Jinear; görevler, takvim, ekip sohbeti ve dosya depolama özelliklerine sahip bir proje yönetim paketidir. Kendi sunucunuzda çalışır. Veriler sizin kontrolünüzdedir."
    },
