// NOTE: trimmed for jinear-site (marketing). The app-only `dateFnsLocale`
// entry and its date-fns/react imports were removed; this site is English-only
// and does not format dates from these strings.
const translations = {
    hi: {
        en: "hi",
        tr: "selam"
    ...
    homescreenHeroText: {
        en: "Jinear is a project management suite, tasks, calendar and file storage, that runs on your own server. You control the data.",
        tr: "Jinear; görevler, takvim ve dosya depolama özelliklerine sahip bir proje yönetim paketidir. Kendi sunucunuzda çalışır. Veriler sizin kontrolünüzdedir."
    },
    ...
    pricingScreenHeroText: {
        ...
        tr: "Kullanıcı başına ödenen ek maliyetlere son verin. Tek bir sabit fiyatla sınırsız proje ve çalışma alanına sahip olun. Faturanızın değil, ekibinizin büyümesine odaklanın."
    },
    ...
    landingPageFeature1: {
        en: "Build projects together.",
        tr: "Projeleri birlikte inşa edin."
    },
    landingPageFeature1Text: {
        en: "Plan, assign, and track work across your team. Your project data stays on your server.",
        tr: "Ekibiniz genelinde iş planlayın, atayın ve takip edin. Proje verileriniz sunucunuzda kalır."
    },
    ...
    landingPageFeature1Sub2Title: {
        en: "Files, attached locally",
        tr: "Yerel olarak eklenmiş dosyalar"
    },
    landingPageFeature1Sub2Text: {
        en: "Files stored on your server, right next to the task",
        tr: "Dosyalar sunucunuzda, ilgili görevin yanında saklanır"
    },
    ...
    landingPageFeature1AlternativeTo: {
        en: "Self-hosted alternative to:",
        tr: "Bunlara kendi sunucunuzdan alternatif:"
    },
    landingPageFeature2: {
        en: "Manage time, privately.",
        tr: "Zamanı gizlilikle yönetin."
    },
    landingPageFeature2Text: {
        en: "View deadlines and project timelines alongside your calendar events. Stays on your server. Syncs with Google or Apple Calendar(one way) optionally.",
        tr: "Son tarihleri ve proje zaman çizelgelerini takvim etkinliklerinizle birlikte görüntüleyin. Sunucunuzda kalır. İsteğe bağlı olarak Google veya Apple Takvim(tek yönlü) ile senkronize olur."
    },
    ...
    landingPageFeatureChat: {
        en: "Chat without the surveillance.",
        tr: "Gözetlenmeden konuşun."
    },
    landingPageFeatureChatText: {
        en: "Real-time channels and DMs, linked directly to your tasks. All conversations stay inside your own infrastructure.",
        tr: "Görevlerinizle doğrudan bağlantılı gerçek zamanlı kanallar ve DM'ler. Tüm konuşmalar kendi altyapınızın içinde kalır."
    },
    ...
    landingPageFeatureChatSub1Text: {
        en: "Keep project discussions on your own network",
        tr: "Proje tartışmalarını kendi ağınızda tutun"
    },
    ...
    landingPageFeatureStorage: {
        en: "Files that actually belong to your team.",
        tr: "Dosyalar gerçekten sizin."
    },
    landingPageFeatureStorageText: {
        en: "Upload, share, and control access with granular permissions. Files are stored directly on your server, not shipped off to someone else’s cloud.",
        tr: "Ayrıntılı izinlerle yükleyin, paylaşın ve erişimi kontrol edin. Dosyalar doğrudan kendi sunucunuzda saklanır, başkasının bulutuna gönderilmez."
    },
    ...
    landingPageFeatureStorageSub1Text: {
        ...
        tr: "Kimin görüntüleyip düzenleyebileceğini, kimin indirebileceğini siz belirleyin."
    },
    ...
    landingPageFeatureStorageSub2Text: {
        en: "No more 'Where is that file?' It's on your server, in the project folder.",
        tr: "'O dosya nerede?' endişesi yok. Sunucunuzda, proje klasöründe."
    },
    ...
    landingPageFeatureStorageSub3Text: {
        en: "Fast, available across devices, and only you can access it.",
        tr: "Hızlı, cihazlar arasında erişilebilir ve yalnızca siz erişebilirsiniz."
    },
    ...
    landingPageHeroFeature1Title: {
        en: "Your tasks. Your server.",
        tr: "Kendi görevleriniz, kendi sunucunuz."
    },
    landingPageHeroFeature1Text: {
        en: "Full task management running on your infrastructure",
        tr: "Kendi altyapınızda çalışan eksiksiz görev yöneticisi"
    },
    landingPageHeroFeature2Title: {
        en: "Full visibility. Full control.",
        tr: "Eksiksiz görünürlük. Tam kontrol."
    },
    landingPageHeroFeature2Text: {
        en: "See what your team is up to, privately",
        tr: "Özel olarak ekip takibi"
    },
    landingPageHeroFeature3Title: {
        en: "Deadlines. Privately tracked.",
        tr: "Son tarihler. Gizlilikle takip edilir."
    },
    landingPageHeroFeature3Text: {
        en: "Calendar and scheduling that stays on your server",
        tr: "Kendi sunucunuzda, kendi takviminiz"
    },
    landingPageHeroFeature4Title: {
        en: "One place. Yours.",
        tr: "Size ait olan tek bir yer."
    },
    landingPageHeroFeature4Text: {
        en: "Complete overview of your workspace, no third parties",
        tr: "Üçüncü taraf olmadan çalışma alanına kapsamlı bakış"
    },
    ...
    // Navbar
    homescreenNavSelfHosting: {
        en: "Self-Hosting",
        tr: "Kendi Sunucun"
    },

    // CallToAction
    homescreenCtaSelfHostLabel: {
        en: "Self-host",
        tr: "Kendi sunucuna kur"
    },
    homescreenCtaCloudLabel: {
        en: "Cloud",
        tr: "Bulut"
    },
    homescreenDeployFree: {
        en: "Deploy Free",
        tr: "Ücretsiz Kur"
    },
    homescreenTryCloud: {
        en: "Try Cloud Version",
        tr: "Bulut Sürümünü Dene"
    },

    // SocialProofBar
    landingPageProofMit: {
        en: "AGPL-3.0 Licensed",
        tr: "AGPL-3.0 Lisanslı"
    },
    landingPageProofDocker: {
        en: "Docker-based",
        tr: "Docker tabanlı"
    },
    landingPageProofOneCommand: {
        en: "One-command install",
        tr: "Tek komutla kur"
    },
    landingPageProofSelfHostable: {
        en: "Self-hostable",
        tr: "Kendi sunucuna kur"
    },
    landingPageProofOpenSource: {
        en: "Open source",
        tr: "Açık kaynak"
    },

    // ProblemBar
    landingPageProblemEyebrow: {
        en: "The problem with SaaS",
        tr: "SaaS'ın Sorunu"
    },
    landingPageProblemTitle: {
        en: "Your team's most sensitive work lives on someone else's server.",
        tr: "Takımınızın en kritik verileri başkasının sunucusunda duruyor."
    },
    landingPageProblem1Title: {
        en: "Prices keep going up",
        tr: "Fiyatlar sürekli artıyor"
    },
    landingPageProblem1Text: {
        en: "Per-seat pricing adds up as teams grow, and costs tend to increase with each renewal.",
        tr: "Ekip büyüdükçe kişi başı maliyetler de artıyor. Her yenileme döneminde fiyatların yükselmesi artık alışılageldik."
    },
    landingPageProblem2Title: {
        en: "Your data, their servers",
        tr: "Verileriniz, onların sunucuları"
    },
    landingPageProblem2Text: {
        en: "Most project tools store your data on their servers. You're relying on their security practices and their policies.",
        tr: "Çoğu proje aracı verilerinizi kendi sunucularında saklar. Güvende olup olmadığı tamamen onların güvenlik anlayışına kalıyor."
    },
    landingPageProblem3Title: {
        en: "Vendor lock-in is real",
        tr: "Tedarikçi bağımlılığı gerçek"
    },
    landingPageProblem3Text: {
        en: "Pricing changes. Services get acquired or discontinued. If your data is hard to export, moving on is painful.",
        tr: "Fiyatlar değişir. Şirketler el değiştirir ya da kapanır. Verilerinizi çıkarmak güçse, başka bir yere geçmek de öyle olur."
    },

    // SelfHostHero
    landingPageSelfHostEyebrow: {
        en: "// deploy in under 5 minutes",
        tr: "// 5 dakikadan kısa sürede kur"
    },
    landingPageSelfHostTitle1: {
        en: "Everything your team needs.",
        tr: "Takımınızın ihtiyacı olan her şey"
    },
    landingPageSelfHostTitle2: {
        en: "On your infrastructure.",
        tr: "kendi altyapınızda"
    },
    landingPageSelfHostText: {
        en: "Jinear ships as a single Docker Compose stack. Point it at your domain, run one command, and you're live. Updates are a one-liner. Backups are yours.",
        tr: "Jinear tek bir Docker Compose paketiyle gelir. Alan adınızı girin, tek komut çalıştırın, sisteminiz hazır. Güncellemek için tek satır yeterli; yedekler sizde."
    },
    landingPageSelfHostFeature1Title: {
        en: "Your storage",
        tr: "Sizin depolama alanınız"
    },
    landingPageSelfHostFeature1Text: {
        en: "File storage is bundled into the Docker stack using MinIO. No external services needed, the files live on your disk.",
        tr: "Dosya depolama, MinIO kullanılarak Docker paketine dahildir. Harici bir servise gerek yoktur ve dosyalar kendi diskinizde tutulur."
    },
    landingPageSelfHostFeature2Title: {
        en: "Your backups",
        tr: "Sizin yedekleriniz"
    },
    landingPageSelfHostFeature2Text: {
        en: "Automated daily database backups included. You set the retention, you keep the files.",
        tr: "Otomatik günlük veritabanı yedekleme dahildir. Saklama süresini siz belirlersiniz, yedekler sizde kalır."
    },
    landingPageSelfHostFeature3Title: {
        en: "Any cloud or bare metal",
        tr: "İster bulut sağlayıcı ister fiziksel sunucu"
    },
    landingPageSelfHostFeature3Text: {
        en: "DigitalOcean, Hetzner, AWS, your own rack. If it runs Docker, it runs Jinear.",
        tr: "DigitalOcean, Hetzner, AWS, kendi sunucunuz. Docker çalışıyorsa, Jinear çalışır."
    },

    // HeroFeatures section header
    landingPageHeroFeaturesEyebrow: {
        en: "What you get",
        tr: "Kazanımlarınız"
    },
    landingPageHeroFeaturesTitle: {
        en: "A complete suite, fully under your roof.",
        tr: "Kendi sunucunuzda, eksiksiz bir paket."
    },

    // ComplianceSection
    landingPageComplianceEyebrow: {
        en: "Built for teams that take compliance seriously",
        tr: "Uyumluluğu ciddiye alan ekipler için"
    },
    landingPageComplianceTitle: {
        en: "GDPR ready. Audit-ready. Actually private.*",
        tr: "GDPR uyumlu. Denetime hazır. Gerçekten özel.*"
    },
    landingPageCompliance1Title: {
        en: "GDPR compliant by design",
        tr: "Tasarım gereği GDPR uyumlu"
    },
    landingPageCompliance1Text: {
        en: "Data stays in whatever region you deploy to. No third-party processors to declare.",
        tr: "Veriler, sunucuyu nerede çalıştırırsanız o bölgede kalır. GDPR kapsamında beyan gerektiren üçüncü taraf işlemci yok."
    },
    landingPageCompliance2Title: {
        en: "Full audit trail",
        tr: "Tam denetim izi"
    },
    landingPageCompliance2Text: {
        en: "Complete access to your own logs, database, and backups. No black boxes.",
    ...
    landingPageComplianceNote: {
        ...
        tr: "* Bunlar kendi sunucunuza kurulum için geçerlidir. Bulut sürümü diğer SaaS hizmetleri gibi çalışır ve verileriniz bizim sunucularımızda tutulur."
    },

    // ComparisonSection
    landingPageComparisonTitle: {
        en: "Two ways to run Jinear.",
        tr: "Jinear'ı çalıştırmanın iki yolu."
    },
    landingPageComparisonSubtitle: {
        en: "Pick what works for your team.",
        tr: "Ekibinize uygun olanı seçin."
    },
    landingPageComparisonNote: {
        en: "* Data migration between cloud and self-hosted is not supported yet.",
        tr: "* Bulut ve kendi sunucunuz arasında veri geçişi henüz desteklenmemektedir."
    },
    landingPageComparisonRow1Label: {en: "Setup time", tr: "Kurulum süresi"},
    landingPageComparisonRow1Cloud: {en: "Instant", tr: "Anında"},
    landingPageComparisonRow1Self: {en: "~5 min", tr: "~5 dk"},
    landingPageComparisonRow2Label: {en: "Data location", tr: "Veri konumu"},
    landingPageComparisonRow2Cloud: {en: "Our servers", tr: "Geliştiricinin sunucuları"},
    landingPageComparisonRow2Self: {en: "Your servers", tr: "Sizin sunucularınız"},
    landingPageComparisonRow3Label: {en: "Price", tr: "Fiyat"},
    landingPageComparisonRow3Cloud: {en: "Free / Pro", tr: "Ücretsiz / Pro"},
    landingPageComparisonRow3Self: {en: "Free forever", tr: "Sonsuza kadar ücretsiz"},
    landingPageComparisonRow4Label: {en: "Maintenance", tr: "Bakım"},
    landingPageComparisonRow4Cloud: {en: "We handle it", tr: "Geliştirici halleder"},
    landingPageComparisonRow4Self: {en: "You handle it", tr: "Siz halledersiniz"},
    landingPageComparisonRow5Label: {en: "Compliance control", tr: "Uyumluluk kontrolü"},
    landingPageComparisonRow5Cloud: {en: "Standard", tr: "Standart"},
    landingPageComparisonRow5Self: {en: "Full", tr: "Tam"},
    landingPageComparisonRow6Label: {en: "Updates", tr: "Güncellemeler"},
    landingPageComparisonRow6Cloud: {en: "Automatic", tr: "Otomatik"},
    landingPageComparisonRow6Self: {en: "One command", tr: "Tek komut"},
    landingPageComparisonCloud: {
        en: "☁️ Jinear Cloud",
        tr: "☁️ Jinear Bulut"
    },
    landingPageComparisonSelfHosted: {
        en: "🖥️ Self-Hosted",
        tr: "🖥️ Kendi Sunucunuz"
    },
    ...
    landingPageOpenSourceStar: {
        ...
        tr: "GitHub yada GitLab üzerinden repoyu favla."
    },

    // BottomCta
    landingPageBottomCtaTitle: {
        en: "Start using Jinear",
        tr: "Jinear'ı kullanmaya başlayın"
    },
    landingPageBottomCtaDeployTitle: {
        en: "Deploy it yourself",
        tr: "Kendiniz kurun"
    },
    landingPageBottomCtaDeployText: {
        en: "Free to self-host under AGPL-3.0. Your servers, your data.",
        tr: "AGPL-3.0 lisansı ile ücretsiz. Kendi sunucunuzda kendi veriniz."
    },
    landingPageBottomCtaDeployBtn: {
        en: "Read the install guide",
        tr: "Kurulum kılavuzunu oku"
    },
    landingPageBottomCtaCloudTitle: {
        en: "Start on the cloud",
        tr: "Bulutta başlayın"
    },
    landingPageBottomCtaCloudText: {
        en: "Free for up to 3 people. No credit card.",
        tr: "3 kişiye kadar ücretsiz. Kredi kartı gerekmez."
    },
    landingPageBottomCtaCloudBtn: {
        en: "Create a free account",
        tr: "Ücretsiz hesap oluştur"
    },

    // Footer - Self-Hosting column
    landingPageFooterSelfHosting: {
        en: "Self-Hosting",
        tr: "Kendi Sunucunuz"
    },
    landingPageFooterInstallGuide: {
        en: "Install Guide",
        tr: "Kurulum Kılavuzu"
    },
    landingPageFooterDocs: {
        en: "Documentation",
        tr: "Dokümantasyon"
    },
};
