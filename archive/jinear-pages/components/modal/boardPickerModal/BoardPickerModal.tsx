...
import { useFilterTaskBoardsQuery } from "@/store/api/taskBoardListingApi";
import {
...
const BoardPickerModal: React.FC<BoardPickerModalProps> = ({}) => {
  ...
  const { data: taskBoardListingResponse, isFetching } = useFilterTaskBoardsQuery(
    { workspaceId: workspaceId || "", teamId: teamId || "", name: searchValue },
    { skip: workspaceId == null || teamId == null }
  );
