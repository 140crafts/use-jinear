...
const NewTopicScreenBreadcrumb: React.FC<NewTopicScreenBreadcrumbProps> = ({}) => {
  ...
  return (
    <Breadcrumb>
      ...
      <BreadcrumbLink label={t("newTopicScreenTitle")} url={`/${currentWorkspace?.username}/${currentteam?.name}/topic/new`} />
    </Breadcrumb>
  );
};
