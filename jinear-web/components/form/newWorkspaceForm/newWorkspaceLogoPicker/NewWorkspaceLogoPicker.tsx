...
import styles from "./NewWorkspaceLogoPicker.module.css";

interface NewWorkspaceLogoPickerProps {
...
const logger = Logger("NewWorkspaceLogoPicker");

const NewWorkspaceLogoPicker: React.FC<NewWorkspaceLogoPickerProps> = ({
  selectedFile,
  setSelectedFile,
  selectedFilePreview,
...
export default NewWorkspaceLogoPicker;
