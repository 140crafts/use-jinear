...
export type ProjectDomainCnameCheckResultType =
  "CNAME_CHECK_OK_READY_FOR_MANAGER"
  | "CNAME_CHECK_FAILED"
  | "SETUP_COMPLETED"
  | "CANCELLED_CNAME_NOT_SETUP_IN_TIME";

export type ProjectDomainType = "AUTO_GENERATED" | "CUSTOM";

export type ProjectFeedAccessType = "PRIVATE" | "PUBLIC" | "GUESTS_ONLY";

export type ProjectPostCommentPolicyType =
  "WORKSPACE_ADMINS"
  | "PROJECT_LEAD"
  | "PROJECT_TEAM_ADMINS"
...
export type ProjectPostInitializeAccessType =
  "WORKSPACE_ADMINS"
  | "PROJECT_LEAD"
  | "PROJECT_TEAM_ADMINS"
  | "PROJECT_TEAM_MEMBERS"
